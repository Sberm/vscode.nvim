...
theme.set_highlights = function(opts)
    ...
    hl(0, 'CursorLine', { bg = c.vscCursorLineBack })
    ...
    hl(0, 'CursorLineNr', { fg = c.vscCursorLineNrFront, bg = c.vscCursorLineBack })
    ...
    hl(0, 'Title', { fg = c.vscHowcBlue, bg = c.vscNone, bold = true })
    ...
    hl(0, 'Todo', { fg = c.vscYellowOrange, bg = c.vscYellowBack, bold = true })
    ...
    -- Markdown
    hl(0, 'markdownBold', { fg = isDark and c.vscBlue or c.vscHowcBlue, bold = true })
    ...
    hl(0, 'markdownHeadingDelimiter', { fg = isDark and c.vscBlue or c.vscHowcBlue, bg = 'NONE' })
